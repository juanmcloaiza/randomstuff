...
class Widget(QWidget):
    ...
    def layoutUI(self):
        ...
        self.exitFrame.setStyleSheet("background-color: green;")
        ...
        self.numpadFrame.setStyleSheet("background-color: white;")
        ...
        self.adminFrame.setStyleSheet("background-color: red;")
